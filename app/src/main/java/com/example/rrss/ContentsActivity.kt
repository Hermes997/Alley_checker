...
import com.example.rrss.databinding.ActivityContentsBinding
...
class ContentsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textViewTi1.text = publisher
        binding.textViewTi2.text = title
        binding.textViewTi3.text = contents
        binding.textViewTi4.text = date

        profileImage.addOnSuccessListener {
            Glide.with(binding.root).load(it).into(binding.imageViewTi1)
        ...
        if (size != 0) {
            ...
            for (i in 0 until size) {
                val image = storage.getReference("postsImages/${date1.toString()}/${i}").downloadUrl
        ...
        binding.viewPagerTi1.adapter = viewPageradapter

        binding.buttonTi2.setOnClickListener {
            deleteAlert()
        }

        binding.buttonTi3.setOnClickListener {
            comentUpload()
        }

        binding.swipeTi1.setOnRefreshListener {
            represent()
            binding.swipeTi1.isRefreshing = false
        }
        ...
        val alert = AlertDialog.Builder(this)
            ...
            .setPositiveButton("삭제") {
                ...
                if(user?.uid.toString() == uid.toString()){
                    ...
                    db.collection("posts").document(docPath!!)
                        .delete()
    ...
    private fun comentUpload() {
        ...
        val finalContent: String = binding.editTextTi1.text.toString()
    ...
    private fun uploader(comentInfo: ComentInfo){
        ...
        db.collection("posts").document(docPath!!).collection("coments")
            .add(comentInfo)
            .addOnSuccessListener {
                confirm()
            }
    ...
    private fun represent(){
        ...
        db.collection("posts").document(docPath!!)
            ...
            .addOnSuccessListener { result ->
                ...
                binding.recyclerViewTi1.adapter = adapter
                adapter.notifyDataSetChanged()
            }
            .addOnFailureListener { exception ->
            }

        binding.recyclerViewTi1.adapter = blindError
    }
}
